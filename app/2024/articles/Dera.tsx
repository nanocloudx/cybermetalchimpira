  ...
  return (
    <div id={info.id} className={style.dera}>
      ...
      <Page pageNumber={startPage + 1}>
        <section>
          <ul>
            ...
            <li>
              ...
              <ul>
                <li>人の目を見て話せない</li>
                <li>会話のキャッチボールができない、基本的に自分語りばっか</li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>周りが見えなさすぎて、てめえ自身を客観視できていない</li>
        ...
        <h2>1年目の取り組み</h2>
        <p>
          俺が真っ先に気になったのは、BMIがほぼ標準なのに見た目が小太りな所だ。そして顔付きと目に覇気がねぇって所だ。
          これはあからさまに筋肉とテストステロンが少ねぇ奴の特徴だ。
        </p>
        <p>
          だから筋トレと食生活の改善をさせたんだ。筋トレと言っても軽く汗をかく程度の運動じゃあダメだ。ジムでフリーウェイト中心に1時間半くらい限界まで追い込むトレーニングを週5以上でやらねぇとよっぽど才能がある奴以外は体も見た目も全く変わらねぇ。<br/>
          体を変えるには筋トレだけでなくタンパク質中心の食生活も必要になる。筋トレで筋繊維をぶっ壊しても、そいつらを再生してやるための栄養がなければ筋繊維は十分に回復せず、結果体はあまり変わんねぇ感じになるからな。<br/>
          幸いにもそいつは筋トレのやる気はあったみたいだから、正しい知識さえ頭に叩き込んでやれば変われるって期待はできた。
          詳細には語らねぇが、筋トレ関連で奴にこの1年間でやらせたことはこうだ。
        </p>
        <ul>
          <li>筋肉・脂肪関係なくめちゃめちゃ体重を増やす期間(増量期)と脂肪を削って体を絞る時期(減量期)を一定周期で実施</li>
          <li>ジムに週5回以上で通わせた</li>
      ...
      <Page pageNumber={startPage + 2}>
        <ul>
          ...
          <li>減量期は基本的に脂質制限をして、1日の脂質を30g程度、糖質量は徐々に減らした</li>
        ...
        <p>
          筋トレをして終わりではなくボディビル大会にも出場させてやった。理由はいくつかある。<br/>
          まず、筋トレ初心者の身でボディビルに出ることでメンタルが図太くなれる。
          こういう大会では、公衆の面前でパンツ一丁でドヤ顔しながらてめえ自身を最大限にナルシストに見せる必要がある。しかもこんな弱者なんかよりずっと良い体をした男達しかいない中でだ。人生でトップレベルで恥ずかしいことだろうなぁ？だが、逆を言えばこれより恥ずかしいことなんて滅多にない。だからこそ今後ちょっとやそっとの失敗も女にアプローチかけることも大概のことは一切怖くなくなる。<br/>
          次に、単純により良い体になれるってことだ。
          人は目標があるとより頑張れるから自然と結果も付いてくる。そして何より人様の前でパンツ一丁の姿を強制的に見せつけることになるから、大体の奴は最大限に良い体に仕上げようと頑張るだろうな。そしてあの弱者も例に漏れず頑張っていたらしく、体脂肪率は最終的に6%程度までいったらしい。大会の結果自体は予選落ちだったが、奴自身は人生初の仕上がった体に手応えを感じていたようだった。
        </p>
        <p>
          筋トレ以外では、周りの人間の言動を観察・分析するってこともやらせてみた。
          信じられねぇ話かもしれんが、なんと奴は30年以上の人生でほとんどそういった人間観察をしてこなかったようで、何をどう観察すれば良いのか全く分かっていなかった。とりあえず、テメェと同じようなクソな内面・性格を持っている奴の言動を見て、なぜそのような行動するのか奴なりに推測するように教えてやった。
          そのお陰かてめえ自身のクソな内面を自覚し始め改めるようになった。そういうわけで、空気が読めねぇとか内心思いっきり人を見下すといった人間関係の構築において致命的な部分は多少マシになったみてぇだ。
        </p>
        <h3>成果振り返り(1年目)</h3>
        <p>
          1年目は肉体改造とテストステロンの増加を中心にトレーニングを行なわせた。それと並行して奴と同じようなクソな内面を持つ奴の観察・分析も行わせた。その成果はこんな感じだ。
        </p>
        <ul>
          <li>並の男以上の体つきになった</li>
      ...
      <Page pageNumber={startPage + 3}>
        ...
        <p>
          ...
          ただここで大きな問題が表面化してしまった。奴は全くもって自身を客観視できていなかった。筋トレして体つきが変わったことでかなり自信過剰になっていた。<br/>
      ...
      <Page pageNumber={startPage + 5}>
        ...
        <h3>成果振り返り(2年目)</h3>
        <p>
          この年は奴の外面が1番進化した年だったと思う。あと内面的にも奴はてめえ自身を客観的に見られるようになったと思うし、女を神話上の生物ではなく同じ現代で生きる人間だと思えるようになったことも進歩だと思う。具体的にはこんな感じだ。
        </p>
        <ul>
      ...
      <Page pageNumber={startPage + 7}>
        <p>
          ...
          初の彼女に訳もわからずに一方的に振られたことはクソほどショックだったらしいが、ヤケ酒に付き合ってくれたダチに言われたことも相当頭にきていたらしい。奴はサンドバッグを全力で殴りつけながら、愚痴を限界まで叫び散らかしてやがった。
      ...
      <Page pageNumber={startPage + 9}>
        ...
        <p>
          ...
          確かに対価に見合わなかったりあまり意味がねぇ苦労はバカのする事だしそれは避けた方がいい。でもな、てめえ自身の成長のための苦労まで避けるのは違うだろ？その苦労は買ってでもすべきだと思う。特に弱ええ奴が多い今この時代に必要な苦労だと思う。<br/>
