  ...
  return (
    <div id={info.id}>
      ...
      <Page pageNumber={startPage + 4}>
        <p>最後の苦味は、ほぼ赤ワインに特有の味覚です。苦味はやや特殊な感覚であり、発酵時に生じる苦味は味覚の苦味ですが、渋いと感じるのは純粋に苦味という味覚では無く、タンニンがもたらす収斂性という触覚です。これはタンニンが歯茎の粘膜と結合し粘膜を破壊することによって生じる触覚で、これを感じるのは舌では無く歯茎です。主に樽熟成をしたワインなどでは、純粋に舌が感じる苦味も生じますが、ブドウのタンニンに由来する渋みは、舌で感じる苦味という味覚では無く、歯茎で感じる触覚です。やや不思議な話をしましたが、舌で感じる苦味と、歯茎で感じる収斂性という触覚が、それぞれワインの苦味です。</p>
