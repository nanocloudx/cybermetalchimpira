  ...
  return (
    <div id={info.id}>
      ...
      <Page pageNumber={startPage + 2}>
        ...
        <h3>「東京音頭」</h3>
        <p>難易度：★☆☆☆☆<br/>東京都内の定番曲。振り付けも優しく、5つの動作をループするだけなので初見ですぐ踊れるようになるでしょう。生歌が聴ける会場も。
        </p>
        <h3>「ダンシング・ヒーロー」</h3>
        <p>難易度：★☆☆☆☆<br/>筆者が盆踊りにハマるきっかけとなった曲。踊るだけでなく、周りの人と「ハイハイハイハイ！」と声を出して盛り上がる要素があり、よりハイテンションで楽しめる曲。中央区でよくかかります。
        </p>
        <h3>「牛ちゃんマンボ」</h3>
        <p>難易度：★★☆☆☆<br/>牛肉を食べようというキャンペーンソングで、振り付けがかわいく楽しい筆者のお気に入り曲。限られた会場でしかかからないようで、少なくとも「深川ギャザリア
          盆踊り大会」（木場）では踊ることができました。</p>
        <h3>「東京オリンピック2020音頭」</h3>
        <p>難易度：★★★★★<br/>単純にループの振り付けではなく、さらに間奏で五輪競技を表すポーズが入り、とびきり難易度が高い曲。頑張って覚えたのにオリンピック開催以降は滅多にかからなくなってしまいました。
        </p>
      </Page>
