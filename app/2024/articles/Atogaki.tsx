    ...
    <div id={info.id}>
      ...
      <Page pageNumber={startPage + 1}>
        ...
        <p>
          ...
          運転席の画面で Steam が動くので本当にゲーム機として遊べる。車のハンドル使ってレーシングゲームが遊べる。まじで意味わからん。謎機能や隠しコマンドも多くて、例えばドアをロックしたときの音を自分の好きな音に書き換えられるので、マクドナルドでポテトが揚がる音とか、Windowsのシャットダウン音とかに上書きできちゃう。鍵閉めるたびに流れるのがくだらなすぎて面白い(多分すぐ飽きる)。
        </p>
        <p>
          謎機能もありつつ、AI制御の自動運転は大変優秀で、次世代の車なんだなぁと感心する今日このごろ。AIといえば今年の<b>サイバーメタルチンピラガール</b>(表紙絵)もAIに描いてもらいました。昨年に引き続き生成絵のクオリティには驚かされます。
        </p>
        <p>
