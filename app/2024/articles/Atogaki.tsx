    ...
    <div id={info.id}>
      <Page pageNumber={startPage}>
        ...
        <p>
          ...
          なぜか運転席で Vampire Survivors が遊べる。車のハンドル使ってレーシングゲームも遊べるのだけど本体のタイヤも動くのでシュール。謎機能や隠しコマンドも多くて、例えばドアをロックしたときの音を自分の好きな音に書き換えられるので、マクドナルドでポテトが揚がった音とか、Windowsのシャットダウン音とかに上書きできちゃう。鍵閉めるたびに流れるのがくだらなすぎて面白い(多分すぐ飽きる)。
        </p>
        <p>
