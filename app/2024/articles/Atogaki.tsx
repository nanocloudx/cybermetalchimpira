    ...
    <div id={info.id}>
      <Page pageNumber={startPage}>
        ...
        <p>
          ...
          特殊なレンタカーの話は面白すぎるので割愛するとして(えぇ...)、返却した後、やはり自分の車が欲しくなっちゃったんですよね。同時期に他のチンピラ共も車買ってて超羨ましかったのもある。いいなぁ。それで私も買ってしまいました。<b>Tesla Model 3</b>。
        </p>
        <p>
          テスラは電気自動車なんだけど、もはや車というか走るゲーミングPCなんですよね。<br/>
          運転席の画面で Steam
          が動くので本当にゲーム機として使える。車のハンドル使ってレーシングゲームも遊べちゃうのだけど本体のタイヤも動くのでシュール。謎機能や隠しコマンドも多くて、例えばドアをロックしたときの音を自分の好きな音に書き換えられるので、マクドナルドでポテトが揚がった音とか、Windowsのシャットダウン音とかに上書きできちゃう。鍵閉めるたびに流れるのがくだらなすぎて面白い(多分すぐ飽きる)。
        </p>
        <p>
