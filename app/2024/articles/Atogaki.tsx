    ...
    <div id={info.id}>
      <Page pageNumber={startPage}>
        ...
        <p>
          ...
          なぜか運転席で Vampire Survivors が遊べる。車のハンドル使ってレーシングゲームも遊べる(本体のタイヤも動くのでシュール)。謎機能や隠しコマンドも多くて、例えばドアをロックしたときの音を自分の好きな音に書き換えられるので、マクドナルドでポテトが揚がった音とか、Windowsのシャットダウン音とかに上書きできちゃう。鍵閉めるたびに流れるのがくだらなすぎて面白い(多分すぐ飽きる)。これもうわかんねぇな...
        </p>
        <p>
        ...
        <p>
          また著者の知人友人の方、次回の執筆に参加してみませんか？本当はもっとエクスタシーを感じたいんじゃないですか？最もフィジカルで、最もプリミティブで、そして最もフェティッシュな執筆活動をチンピラ一同応援させていただきます。気軽に連絡ください。
        </p>
        <p>
