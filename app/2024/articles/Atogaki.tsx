    ...
    <div id={info.id}>
      <Page pageNumber={startPage}>
        ...
        <p>
          ...
          なぜか運転席で Vampire Survivors
          が遊べたり、車のハンドル使ってレーシングゲームも遊べます(本体のタイヤも動くのでシュール)。謎機能や隠しコマンドも多く、ドアをロックしたときの音を自分の好きな音に書き換えられるので、マクドナルドでポテトが揚がった音とか、Windowsのシャットダウン音とかに上書きできちゃう。鍵閉めるたびに流れるのがくだらなすぎて面白い(多分すぐ飽きる)。これもうわかんねぇな...
        </p>
        <p>
          謎機能はさておき、AI制御の自動運転は大変優秀で次世代の車なんだなぁと感心します。AIといえば今年の<b>サイバーメタルチンピラガール</b>(表紙絵)もAIに描いてもらいました。ちなみに本誌は最新の
          React 19 と Next.js 15 で開発した当サークル内製アプリで組版し、校正は GitHub を活用して共同編集しました。チンピラは無駄に最先端なのだ。
        </p>
        <p>
