    ...
    <div id={info.id}>
      ...
      <Page pageNumber={startPage + 1}>
        <section>
          <dl>
            <dt>【起きた事】</dt>
            <dd>入社2日目、どうにも1日目のリーダーの様子がおかしい。プロマネと聞いていたはずなのに、プロマネがいる。
              プロマネ2人体制にするほどの人数とPJ規模でもない。
              2日目の朝から既にいたプロマネに説明を求めたところ、
              「プロジェクトマネージャー？こっちはAさんのリーダー引継ぎって聞いてますよ」
              と、いわれた。
              その他、引継ぎの期間や条件、PJ体制で不明瞭な点を確認した。
              2週間後、もっと凄い異変に遭遇するがそれはまた別の話。
            </dd>
            <dt>【教訓】</dt>
      ...
      <Page pageNumber={startPage + 3}>
        ...
        <section>
          ...
          <dl>
            <dt>【見つけた異変】</dt>
            <dd>業務委託契約の会社で、給与アップの条件として24時間の即答体制を求められた。</dd>
            <dt>【起きた事】</dt>
            <dd>業務委託で毎日4時間相当の労働という話での契約。半分の給与ならば、あと半分は他の仕事をする、その間はスマホの返答や対応はできないという認識でいた。
              だが、雇用主はその状況が理解できず、当たり前のように「24時間いつでも返事をしてくれ」と要求してきた。
            </dd>
            <dt>【教訓】</dt>
            ...
            <dt>【個人的感想】</dt>
            <dd>ま、24時間返答できることというのは、本来なら待機なので給与が発生するのですけどね。
        ...
        <h2>引き返すことができた「異変」</h2>
        <section>
          <h3>契約書が文字化けしている、直した契約書の文字コードがスマホで開けない物、3度目の提出の契約書の合間に全く関係ない大きく不利益な文面が入っている</h3>
          <dl>
            <dt>【見つけた異変】</dt>
            <dd>契約書に大きく不利益になる文面が入っているのにもかかわらず、読みにくいように壊れたファイルを2度送付してくる。</dd>
            <dt>【起きた事】</dt>
